defmodule Desktop.GnomeCategories do
  @moduledoc false
  def categories() do
    [
      {"AudioVideo",
  ...
  def additional_categories() do
    [
      ...
      {"Humanities", "Software for philosophy, psychology and other humanities",
      ...
      {"Maps", "Sofware for viewing maps, navigation, mapping, GPS",
       "Education or Science or Utility"},
      ...
      {"Spirituality", "Religious and spiritual software, theology",
       "Education or Science or Utility"},
      {"Sports", "Sports software", "Education or Science"},
      {"ParallelComputing", "Parallel computing software",
       "Education;ComputerScience or Science;ComputerScience"},
