...
extern int semanage_module_install(semanage_handle_t *ss,
				   char *module_data, size_t data_len, char *name, char *ext_lang){}
extern int semanage_module_install_file(semanage_handle_t *aa,
					const char *module_name){}
extern int semanage_module_remove(semanage_handle_t *gg, char *module_name){}
...
extern int semanage_module_list(semanage_handle_t *ss,
				semanage_module_info_t **zz, int *num_modules){}
extern void semanage_module_info_datum_destroy(semanage_module_info_t *ss){}
extern semanage_module_info_t *semanage_module_list_nth(semanage_module_info_t * list,
							int n){}
extern const char *semanage_module_get_name(semanage_module_info_t *bb){}
